#!/usr/bin/env python3
"""Module that finds a snippet of text to answer a question."""
...
def question_answer(question, reference):
    """Finds a snippet of text within a reference to answer a question.

    Args:
        question: string containing the question to answer.
        reference: string containing the reference document from which
            to find the answer.
    ...
    if answer is None or answer == '' or answer == '[CLS]':
        return None
